  ...
  return (
    ...
    >
      <div className="mx-auto max-w-7xl py-20 sm:py-24">
        ...
        >
                      <Badge variant="outline" className="mb-6 bg-[#090909]/50 border-white/20 text-white/90 rounded-none px-6 py-2 text-base font-medium">
          ...
          >
            {duplicatedTestimonials.map((testimonial, index) => (
              <motion.div
                ...
                viewport={{ once: true, amount: 0.3 }}
                className="flex-shrink-0 w-72 sm:w-80 bg-[#090909]/30 border border-white/10 p-4 sm:p-6 backdrop-blur-sm"
              >
                {/* Avatar */}
                ...
                <blockquote className="text-white/80 text-xs sm:text-sm leading-relaxed">
                  "{testimonial.content}"
                </blockquote>
              </motion.div>
            ))}
