...
- Siempre ten en cuenta que dependiendo de que cosa estés configurando, es probable que ese sea el paso en el que estés, por ej si estas configurando el nombre
o el publico estarás en el paso 1 mientras que si estás configurando base de conocimiento y calendario estarás en el paso 3
`.trim();
