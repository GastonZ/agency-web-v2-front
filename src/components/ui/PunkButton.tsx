  ...
  (
    ...
    const variants: Record<Variant, string> = {
      primary: cn(
        ...
        isDisabled
          ? "shadow-[0_8px_30px_rgba(107,114,128,0.35)]"
          : "shadow-[0_8px_30px_rgba(16,185,129,0.35)]",
        isDisabled ? "ring-1 ring-gray-400/30" : "ring-1 ring-emerald-500/30",
      ...
      secondary: cn(
        ...
        isDisabled ? "text-gray-600 dark:text-gray-400" : "text-emerald-700 dark:text-emerald-300",
        isDisabled ? "ring-1 ring-gray-400/30" : "ring-1 ring-emerald-400/30 hover:ring-emerald-400/40",
        isDisabled ? "hover:bg-gray-400/10" : "hover:bg-emerald-400/20",
        "disabled:opacity-60 disabled:cursor-not-allowed"
      ),
      ghost: cn(
        "bg-transparent",
        isDisabled ? "text-gray-400" : "text-neutral-700 dark:text-neutral-300",
        isDisabled ? "hover:text-gray-400" : "hover:text-emerald-500",
        "disabled:opacity-60 disabled:cursor-not-allowed"
      ),
    };
